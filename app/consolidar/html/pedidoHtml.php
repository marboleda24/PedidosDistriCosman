            ...
            <div class="col-lg-4">
                <div class="card border-primary mb-3" style="max-width: 20rem;">
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary btn-lg btn-block"><a href="despachar_model.php?accion=2&id=<?php echo $id_pedido ?>" style="text-decoration:none;color:#fff">Despachar Pedido</a></button>
                  </div>
                </div>
              </div>
              </div> 
