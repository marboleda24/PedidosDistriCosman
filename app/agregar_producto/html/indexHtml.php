        ...
        <div class="card border-dark mb-3">
          ...
          <div class="card-body">
            ...
            <div class="col-lg-4" style="text-align: right">
                <button type="button" class="btn btn-primary"><a href="lista.php" style="color:#fff">Productos</a></button>
            </div>
            </div><br>
           <div class="row">
       ...
       ?>
        <div class="col-lg-3">
          <form action="model.php" method="post">
                <div class="card mb-3">
                  <a href="deshabilitar.php?img=<?php echo $id_img ?>"><button type="button" class="btn btn-warning">Deshabilitar</button></a>
