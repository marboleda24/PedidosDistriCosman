<!--
 Autor Deyner Steven Rendon Valladares <dsrendon@misena.edu.co>
 Editor Martin Arboleda marboleda@solucionestics.com
 Fecha Noviembre/11/2018
 Fecha Actualización Noviembre/20/2018
 Version 1
-->
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
 ...
 <div class="collapse navbar-collapse" id="navbarColor01">
  <ul class="navbar-nav mr-auto">
   ...
   <li class="nav-item"><a class="nav-link" href="../ingresarImg/">Subir Imagen</a></li>
   <li class="nav-item"><a class="nav-link" href="../agregar_proveedor/">Agregar Proveedor</a></li>
   ...
   <li class="nav-item"><a class="nav-link" href="../borradores/">Borradores</a></li>
   <li class="nav-item"><a class="nav-link" href="../autorizar_pedido">Autorizar Pedido</a></li>
   <li class="nav-item"><a class="nav-link" href="../consolidar">Consolidar</a></li>
  </ul>
  <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
   <a href="../catalogo/lista.php">
    <i class="fas fa-shopping-cart" style="color:#fff;font-size:1.5em;margin: 7px 20px 0px 0px"></i>
   </a>
